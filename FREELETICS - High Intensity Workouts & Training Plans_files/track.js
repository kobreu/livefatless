...
obj+='<param name="movie" value="'+protocol+'freeletics.myomnistar.com/main.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#dfdfdf" />';
obj+='<embed src="'+protocol+'freeletics.myomnistar.com/main.swf" quality="high"  bgcolor="#dfdfdf" width="1" height="1" name="updateFlData" align="middle" allowFullScreen="false" type="application/x-shockwave-flash" allowscriptaccess="always" pluginspage="http://www.macromedia.com/go/getflashplayer" />';
obj+='</object>';
obj+='<script language="JavaScript" type="text/javascript" src="'+protocol+'freeletics.myomnistar.com/clicktrack.php?oid='+getValue+'"></script>';
document.write(obj);
